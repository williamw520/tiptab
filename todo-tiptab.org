...
** TODO Bug: Group container tabs to a new window seems pointing to the last tab of the old window.
** TODO Bug: after dragging couple time, dragging the first tab in a window doesn't remove it from the src window.
