...
** TODO Bug: drag and drop new tab into container doesn't initialize the tab menu handlers.
** TODO Bug: empty search text is not saved.  Refreshing the TipTab page gets back the old search text.
