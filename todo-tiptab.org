...
* Feature TODO
** DONE Bug Fix: Activating the standalone TipTab window might close the wrong blank tab in the presence of other tab managing extensions.
** DONE Window cmd: close all tabs in window.
** DONE Container cmd menu.
** DONE Container cmd: Create tab in container.
** DONE Container cmd: Reload tabs in container.
** DONE Container cmd: Close tabs in container.
** DONE Container cmd: Group all tabs of a container to its own window.
