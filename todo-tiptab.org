...
<ul>
  ...
  <li> Filter tabs by windows or by containers.
  <li> Showing tab attributes with decoration, colors, and status icons.
  <li> Tab commands: reload, mute, pin, copy, screenshot download, various flavors of close commands, etc.
  ...
  <li> Custom hot key.  Key configuration with example key-press.
  <li> Options page.
</ul>
...
<b>Information:</b>
<ul>
  <li>Shift-Ctrl-F is the default hotkey to bring up Tip Tab.</li>
  <li>The custom extension hotkey can be used to bring up Tip Tab.</li>
  <li>The hotkey (either one) can be used to cycle through the tabs.  Enter to select the tab.</li>
  <li>The Options page can be brought up from Firefox's addon manager or from the dropdown menu at upper right hand side.</li>
  <li>Reload the Tip Tab page to refresh all the tabs.</li>
  <li>This extension requires Firefox 59 and up.</li>
</ul>

<b>Issues:</b>
<ul>
  <li>Custom hotkey would not work on special Firefox pages, 
      such as about:newtab, about:addons, about:config, and other privileged pages.
      For security reason, any custom key events are restricted by Firefox on those pages.</li>
  <li>For keyboard navigation, the Tab key will cycle the focus through the tabs, plus onto the Firefox controls on the frame, such as the address bar, the search bar.
      ...
      The custom hotkey will only cycle the focus through the tabs and Tip Tab's search bar.
  </li>
</ul>
