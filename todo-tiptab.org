...
** TODO Bug: Drag and drop at-end or in-front of window has messed up UI animation.
   Looks like tabs_onUpdated() is called during tab moving and interfered with animation.
