...
** DONE Saved searches on the side.  Selected on the saved search limit the shown tabs
** TODO Shortcut keys to saved searches, Ctrl+Shift+[1-9]
** TODO Thumbnail popup when mouse is over the quarter circle at the lower-right corner.
