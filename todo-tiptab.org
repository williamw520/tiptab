...
** TODO Click on anywhere in a window section should activate the window.
** TODO Bigger font for tab title.
** TODO Text based tab view.
** TODO Tab tree view based on tab creator.
