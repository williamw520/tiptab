...
* Feature TODO
** DONE Text view for by-all-tabs type.
** DONE Text view for by-window type.
** DONE Text view for by-container type.
** DONE Saved search items are saved immediately.  Changes can be undone until Done button is clicked.
** TODO Minimize windows.
** TODO Minimize containers.
** TODO Create tab command button in a container.
